...
//            dv.onmouseout = function(e){
//                if (!e) {
//                    e = window.event;
//                }
//                var relTarget = ( e.relatedTarget ? e.relatedTarget : e.toElement );
//                // spsupport.log(relTarget);
//                var evl = relTarget.getAttribute(sp.sfIcon.evl);
//                if (!evl) {
//                    // spsupport.api.addImgEvents(img, relTarget);
//                    relTarget.setAttribute(sp.sfIcon.evl, "1");
//                    relTarget.onmouseout = function(e) {
//                        if (!e) {
//                            e = window.event;
//                        }
//                        var rt = ( e.relatedTarget ? e.relatedTarget : e.toElement );
//                        // spsupport.log(rt);
//                        if (rt.id != "magnifierLens") {
//                            dv.style.display = "block";
//                        }
//                        if (!rt.getAttribute(sp.sfIcon.evl)) {
//                            rt.setAttribute(sp.sfIcon.evl, "1");
